...
ssh root@host01 "set -o xtrace && mkdir kubeflow && git clone https://github.com/katacoda/kubeflow-ksonnet.git kubeflow && sed -i 's/\$HOSTIP/[[HOST_IP]]/g' kubeflow/katacoda.yaml && sed -i 's/\$HOST2IP/[[HOST2_IP]]/g' kubeflow/katacoda.yaml"
